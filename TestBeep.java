...
public class TestBeep {
   ...
   public static void sound(int time_sec) throws InterruptedException, LineUnavailableException 
   {
      ...
      int ctSamplesTotal = SAMPLING_RATE*time_sec;         // Output for roughly 5 seconds
